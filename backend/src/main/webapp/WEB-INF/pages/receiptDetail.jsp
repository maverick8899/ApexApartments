...
<section class="container">
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <c:if test="${receipts[1][0] != null}">
                <%--<c:forEach items="${receipts}" var="r">--%>
                <tr>
                    <td>${receipts[1][0].receiptId}</td>
                    <td>${receipts[1][0].customerId}</td>
                    <td>${receipts[1][0].customerName}</td>
                    <td>${receipts[1][0].customerEmail}</td>
                    <td>
                        <c:url value="${action}/${receipts[1][0].receiptId}" var="apiDel" />
                        <!--<a href="<c:url value="/receipt/${receipts[1][0].receiptId}" />" class="btn btn-success">Cập nhật</a>-->
