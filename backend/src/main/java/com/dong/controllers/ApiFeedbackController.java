...
public class ApiFeedbackController {
    ...
    @CrossOrigin
    public ResponseEntity<Feedback> list(@RequestParam Map<String, String> params) {
        return new ResponseEntity<>(this.feedbackService.createReceipt(params), HttpStatus.OK);
