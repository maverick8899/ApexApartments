...
//    private CustomerService cusService;
    ...
    @GetMapping("/survey")
    public String getSurvey(Model model, @RequestParam Map<String, String> params) {
...
//        model.addAttribute("feedbacks", this.feedbackService.getFeedback(params));
    ...
    public String createSurvey(Model model, @RequestParam Map<String, String> params) {
//        model.addAttribute("receipt", new Receipt());
        model.addAttribute("survey", this.surveyService.createSurvey(params));
        return "survey";
    }
